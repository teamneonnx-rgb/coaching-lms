  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <aside className="sticky top-0 hidden h-screen shrink-0 lg:block">
        <AdminSidebar user={navUser} brand={brand} role={user.role} capabilities={capabilities} />
      </aside>

      <div className="flex min-w-0 flex-1 flex-col">
        {/* Sticky header with mobile hamburger + notification bell */}
        <AdminHeader user={navUser} brand={brand} role={user.role} capabilities={capabilities} />
